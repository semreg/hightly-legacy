    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent-333">
      <ul className="navbar-nav mr-auto">
        <li className="nav-item">
          <a className="nav-link" href="https://github.com/Semreg/streamscreen">Source</a>
        </li>
        <li className="nav-item">
          <a className="nav-link" href="https://github.com/Semreg/streamscreen/issues">Issues</a>
        </li>
        <li className="nav-item">
          <a className="nav-link" href="https://github.com/Semreg/streamscreen/issues">Donate</a>
        </li>
